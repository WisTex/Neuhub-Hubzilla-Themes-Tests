    ...
    <nav>
        ...
        {{else}}
            <ul class="pagination justify-content-center">
                <!-- Previous Button -->
                <li class="page-item {{if $page == 1}} d-none {{/if}}">
                ...
                {{if $max_page>1}}
                    {{for $i=1 to $max_page}}
                        <li class="d-flex justify-content-center align-items-centered-flex justify-content-center align-items-center page-item {{if $i == $page}} active {{/if}}"><a class="page-link" href="{{$base_url}}/messages?type={{$type}}&page={{$i}}">{{$i}}</a></li>
                    {{/for}}
                {{/if}}

                <!-- Next Button -->
                <li class="page-item {{if $page == $max_page}} d-none {{/if}}">
