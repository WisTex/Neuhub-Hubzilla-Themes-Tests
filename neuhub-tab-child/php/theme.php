 ...
 *   * Description: A derivative theme of Neuhub Tab that you can use as a starting point for creating your own themes.
 *   * Version: 1.0
 *   * MinVersion: 8.0
 *   * MaxVersion: 10.0
...
// If you change the name of the theme to `yournewname` change `neuhubtabchild_init` to `yournewname_init` so it has a unique name.
// You will also need to edit the style.php file if you change the directory name.

function neuhubtabchild_init(&$App) {

    App::$theme_info['extends'] = 'neuhub-tab';
